...
import logo from "../../image/Floristman 2.png";
import banner from "../../image/header__banner.png"
            ...
            <header className="header">
                <div className="header__top">
                    <nav className="header__top-nav">
                        <Link to="/contact">
                        <a className="header__top-link">Контакты</a>
                        </Link>
                        <Link to="/aboutUs">
                        <a  className="header__top-link">О нас</a>
                        </Link>
                        <Link to="/contact">
